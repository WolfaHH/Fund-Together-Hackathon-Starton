...
class User
{
    ...
    public function getMetamask(): ?string
    {
        return $this->metamask;
    }

    public function setMetamask(string $metamask): self
    {
    ...
    public function setAnnonceur(?bool $annonceur): self
    {
