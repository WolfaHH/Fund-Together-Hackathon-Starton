...
const Campaign = () => {
    ...
    return (
        <main className="main bg-[#eff2f5] flex flex-col items-center">

            {/* Modale STAKE */}
            <StakeInput open={openStake} setOpen = {setOpenStake} />
            <UnStakeInput open={openUnStake} setOpen = {setOpenUnStake} />

            <style>{CSS}</style>

            <div className="mt-20 flex flex-col items-center justify-center">
                <h1 className="mb-8 text-3xl font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-6xl"><span
                    className="text-transparent bg-clip-text bg-gradient-to-r to-blue-600 from-blue-400">Welcome to</span>'La cagnotte de macron'</h1>
                <p className=" text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Voici une courte description, et en vrai c'est pas une description mais plutôt un slogan tu connais le sang
                    growth.</p>
            </div>
                ...
                <div className="bg-white w-5/12 rounded-2xl shadow-2xl flex flex-col justify-between">
                    ...
                    <div className="m-8 flex flex-col justify-start">
                        <div className="flex justify-between mb-2">
                            <span className="text-2xl text-base font-semibold text-blue-700 dark:text-white"><span className="text-2xl font-bold">10'787 USDT</span> <span className="ml-2 text-sm font-medium text-gray-500">raised on a goal of <strong>70'000 USDT</strong></span> </span>
                            <span className="text-2xl font-bold text-blue-700 dark:text-white">45%</span>
                        </div>
                        ...
                        <span className="mt-2 ml-2 text-lg font-medium text-gray-500 text-center"><strong>107'778 USDT</strong> are staked by contributors in total</span>
                    </div>
                    <div className="px-4 py-5 sm:p-6 ml-3">
                        ...
                        <dd className="pl-2 mt-1 flex items-baseline justify-between md:block lg:flex">
                            <div className="flex items-baseline text-2xl font-bold text-blue-600">
                                1'000 USDT
                                <span className="ml-2 text-sm font-medium text-gray-500">including <strong>$135</strong> of profit for this campaign</span>
                            </div>
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col justify-center items-center ">
                            ...
                            <div className="flex justify-center items-center">
                                ...
                                <button className="ml-2 text-sm font-medium text-gray-500 cursor-pointer"> <strong>Wolfa' (</strong>0x7761...<strong>)</strong></button>
                            </div>

                        </div>
                        <div className="flex justify-center mb-3 mt-10 mr-16">
            ...
            <div className="bg-white w-10/12 rounded-2xl shadow-2xl flex flex-col justify-between mt-16 items-center">
                ...
                <p className="mt-8 mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 text-center ">Here
                    at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value
                    and drive economic growth.Here
                    at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value
                    and drive economic growth.Here
                    at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value
                    and drive economic growth.Here
