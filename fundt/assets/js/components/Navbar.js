    ...
    return (
        ...
        <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8 bg-[#eff2f5]">
            ...
            <div id="crypto-modal" tabIndex="-1" aria-hidden="true"
                 className={active ? "hidden fixed z-50 top-20 right-72 overflow-y-auto overflow-x-hidden" : "fixed z-50 top-20 right-72 overflow-y-auto overflow-x-hidden shadow-2xl rounded-2xl"}>
                <div className="relative w-full max-w-md h-full md:h-auto">

                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <button type="button"
                                className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                data-modal-toggle="crypto-modal" onClick={modalConnectt}>
                        ...
                        <div className="p-6">
                            ...
                            <ul className="my-4 space-y-3">
                                <li>
                                    <a href="#" onClick={() => { connect(); modalConnectt();}}
                                ...
                                <li>
                                    <a href="#"
                                       className=" opacity-25 flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                ...
                                <li>
                                    <a href="#"
                                       className=" opacity-25 flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                        <svg aria-hidden="true" svg className="h-5" viewBox="0 0 75.591 75.591"
                                             xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div>
                                <a href="#"
                                   className="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
                                    <svg aria-hidden="true" className="mr-2 w-3 h-3" aria-hidden="true"
                                         focusable="false" data-prefix="far" data-icon="question-circle" role="img"
