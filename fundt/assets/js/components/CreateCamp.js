...
const CreateCamp = ({isActive, setIsActive}) => {
    ...
    const submit = async (e) =>
    {
        ...
        e.preventDefault();
        let res = await fetch("http://crowdfunding_web3.test/api/store-campaign", {
            method: "POST",
            body: JSON.stringify({
                title: title,
                tagline: tagline,
        ...
        <div >
            <div className="p-6 max-w-6xl mx-auto bg-white rounded-xl shadow-md flex flex-col items-center space-x-4">
                ...
                <form className="w-9/12" onSubmit={submit}>
                    <div className="mb-6">
                        <label htmlFor="title" className="block mb-2 text-base font-medium text-gray-900 dark:text-white"é>Your
                            Title</label>
                    ...
                    <div className="mb-6">
                        ...
                        <input  value={tagline} onChange={(e) => setTagline(e.target.value)} type="tagline" id="tagline" placeholder="Choose a catchy tagline here ! (max 90 char)"
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required/>
                    </div>
                    <div className="flex flex-col items-start mb-6">
                        ...
                        <select id="categ" value={category} onChange={(e) => setCategory(e.target.value)}
                            ...
                            <option value="1">Associatif</option>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea value={description} onChange={(e) => setDescription(e.target.value)} rows="8" type="text" id="description" placeholder="Write a longer description of your project here"
                    ...
                    <div className="mb-6 flex flex-col items-start justify-center w-full">
                        <label htmlFor="dropzone-file"
                               className="block mb-2 text-base font-medium text-gray-900 dark:text-white">Your banner</label>
                        <label htmlFor="dropzone-file"
                    ...
                    <div className="mb-6">
                        <label htmlFor="goal" className="block mb-2 text-base font-medium text-gray-900 dark:text-white"é>Your
                            money goal</label>
